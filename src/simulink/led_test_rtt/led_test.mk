# File name: led_test.mk
# Autogenerated on: 23-Nov-2013 00:14:10
...
SOURCE_FILES        := $(call FORMAT_PATH,.\ext_svr.c) $(call FORMAT_PATH,.\ext_work.c) $(call FORMAT_PATH,.\rtiostream_interface.c) $(call FORMAT_PATH,.\updown.c) $(call FORMAT_PATH,.\rtiostream_tcpip.c) $(call FORMAT_PATH,.\rtiostream_utils.c) $(call FORMAT_PATH,.\ert_main.c) $(call FORMAT_PATH,.\led_test.c) $(call FORMAT_PATH,.\led_test_data.c) $(call FORMAT_PATH,.\MW_led.c) $(call FORMAT_PATH,.\linuxUDP.c)
HEADER_FILES        := $(call FORMAT_PATH,..\..\..\..\..\..\..\..\..\Program Files\MATLAB\R2013b\rtw\c\src\ext_mode\common\ext_svr.h) $(call FORMAT_PATH,..\..\..\..\..\..\..\..\..\Program Files\MATLAB\R2013b\rtw\c\src\ext_mode\common\ext_work.h) $(call FORMAT_PATH,..\..\..\..\..\..\..\..\..\Program Files\MATLAB\R2013b\rtw\c\src\ext_mode\common\updown.h) $(call FORMAT_PATH,..\..\..\..\..\..\..\..\..\Program Files\MATLAB\R2013b\toolbox\coder\rtiostream\src\utils\rtiostream_utils.h) $(call FORMAT_PATH,.\led_test.h)
LIBRARY_FILES       := 
...
COMPILER_CODEGEN_ARGS := -I"E:/MATLAB/SupportPackages/R2013b/linux/include" -I"C:/Users/Lester/Google Drive/13 Fall/EECS 221 Cyber-Phy Sys/project/src/simulink/led_test_rtt" -I"C:/Users/Lester/Google Drive/13 Fall/EECS 221 Cyber-Phy Sys/project/src/simulink" -I"C:/Program Files/MATLAB/R2013b/extern/include" -I"C:/Program Files/MATLAB/R2013b/simulink/include" -I"C:/Program Files/MATLAB/R2013b/rtw/c/src" -I"C:/Program Files/MATLAB/R2013b/rtw/c/src/ext_mode/common" -I"C:/Program Files/MATLAB/R2013b/rtw/c/ert" -I"C:/Program Files/MATLAB/R2013b/toolbox/coder/rtiostream/src/utils" -I"E:/MATLAB/SupportPackages/R2013b/linux/blocks/sfcn/include" -I"E:/MATLAB/SupportPackages/R2013b/linux/blocks/sfcn/src" -I"C:/Program Files/MATLAB/R2013b/toolbox/shared/dspblks/extern/include" -I"C:/Program Files/MATLAB/R2013b/rtw/c/src/rtiostream/rtiostreamtcpip" -O3 -D"MODEL=led_test" -D"NUMST=1" -D"NCSTATES=0" -D"HAVESTDIO=" -D"ON_TARGET_WAIT_FOR_START=1" -D"ONESTEPFCN=0" -D"EXT_MODE=1" -D"TERMFCN=1" -D"MAT_FILE=0" -D"MULTI_INSTANCE_CODE=0" -D"INTEGER_CODE=0" -D"MT=0" -D"CLASSIC_INTERFACE=0" -D"TID01EQ=0" -D"_USE_TARGET_UDP_=" -D"_RUNONTARGETHARDWARE_BUILD_=" -D"EXIT_FAILURE=1" -D"EXTMODE_DISABLETESTING="
